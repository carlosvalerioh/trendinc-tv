...
import {Videos,Video} from "../components/customComponents/videos/Videos"
        ...
        >
            <div className="md:px-4 mt-12 py-6 md:w-11/12 mx-auto">
                ...
                <div className="lg:w-3/4 md:w-11/12 sm:w-full p-3 mt-4 md:mt-6 mx-auto lg:mt-12">
                    <MDXProvider components={{ Row, Col ,Brand,BrandDetail,BrandContent,BrandItem,BrandTitle,Videos,Video,BrandDetailTitle,BrandDetailDescription,BrandDetailImage,BrandDetailHashtag,BrandDetailHeader,BrandDetailText}}>
